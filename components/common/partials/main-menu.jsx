            ...
            <nav className="main-nav w-100 d-xl-block d-none">
                <ul className="menu sf-js-enabled sf-arrows">
                    ...
                    <li className={ pathname.startsWith( '/pages/wishlist' ) ? 'active' : '' }>
                        <ALink href="/pages/wishlist" >Favoris</ALink>
                    </li>
                    <li className={ pathname.startsWith( '/pages/about-us' ) ? 'active' : '' }>
                        <ALink href="/pages/about-us" >Apropos</ALink>
                    </li>
                    <li className={ pathname.startsWith( '/pages/contact-us' ) ? 'active' : '' }>
                        <ALink href="/pages/contact-us" >Contacter nous</ALink>
                    </li>
                    <li className={ pathname.startsWith( '/pages/login' ) ? 'active' : '' }>
