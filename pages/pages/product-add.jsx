...
import { getAttributes, getProducts, getTags, getTaxTypes } from '../../../api';
import { getCategories, saveProduct } from '../../../lib/firebase/firestore';
...
export default function ProductAdd () {
    ...
    useEffect( () => {
        ...
        getCategories((cats)=>{
            setProductCats(cats)
            ////console.log("Categories from firestore ", cats)
        })
    ...
    function categoryChange ( index, value ) {
        ////console.log("Index: ", index, "value: ", !value)
        let temp = [...productCats]  ;
    ...
    const onSelectedImages = (media) =>{
        setProductImages([...media, ...productImages])
    }
    ...
    function addProduct ( e ) {
        ...
        let prod = {
            ...product,
            categories: productCats.filter((cat) => cat.isChecked),
            variants:[],
            pictures: productImages,
            attrs: attrs,
            is_out_of_stock: product.stock_status !== "in-stock"
    ...
    function removeImage ( e, id ) {
        e.preventDefault();
        setProductImages( productImages.filter( image => image.public_id !== id ) );
    }
    ...
    return (
        <>
                                                    ...
                                                    <Form.Group>
                                                        ...
                                                        {/* <Form.Check
                                                            ...
                                                            <Form.Check
                                                                ...
                                                                name="group1"
                                                                value={cat.isChecked}
                                                                onChange={ e => categoryChange( index, e.target.value) }
                                                                type={'checkbox'}
                                                                id={`checkbox-${index+1}`}
                                                            />
                                                            )}
                                                                        ...
                                                                        <div className="mg-thumb-options">
                                                                            ...
                                                                            <div className="mg-toolbar">
                                                                                ...
                                                                                <div className="mg-option set-default float-right">
                                                                                    <a href="#delete" className="text-white mg-remove" onClick={ e => removeImage( e, image.public_id ) }><i className="far fa-trash-alt d-block"></i></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <Form.Group as={ Row } className="align-items-center">
                                                            ...
                                                            <Col lg={ 7 } xl={ 6 }>
                                                                <Form.Control
                                                                    ...
                                                                    onChange={ e => productChange( 'price', Number(e.target.value) ) }
                                                                />
                                                            </Col>
                                                        </Form.Group>
                                                        <Form.Group as={ Row } className="align-items-center">
                                                            ...
                                                            <Col lg={ 7 } xl={ 6 }>
                                                                <Form.Control
                                                                    ...
                                                                    onChange={ e => productChange( 'sale_price', Number(e.target.value) ) }
                                                                />
                                                            </Col>
                                                            { saleSchedule ? ''
                                                                :
                                                ...
                                                <Form.Group as={ Row } className="align-items-center">
                                                    ...
                                                    <Col lg={ 7 } xl={ 6 }>
                                                        <Form.Control
                                                            ...
                                                            className="form-control-modern"
                                                            value={ product.sku }
                                                            onChange={ e => productChange( 'sku', Number( e.target.value) ) }
                                                        />
                                                    </Col>
                                                </Form.Group>
                                                { type === 'simple' ?
            ...
            <MediaGalleryModal onSelectedImages={onSelectedImages} chooseOne={ onlyOneImage } isOpen={ modalOpen ? true : false } onClose={ chooseMedia } />
        </>
    )
}